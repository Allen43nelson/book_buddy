...
$username = $password = $confirm_password = $uid = "";
$username_err = $password_err = $confirm_password_err = $rajagiri_uid_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["uid"]))){
        $rajagiri_uid_err = "Please enter uid.";     
    } else{
        $uid = trim($_POST["uid"]);
        }
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO users (username, password, uid) VALUES (?, ?, ?)";
